...
export function SidebarWrapper({ children, ...props }: any) {
  ...
  const loginLink = {
    label: "Sign In",
    href: "/projects/solar-sailors-app/applications/nextjs/login",
    icon: (
      <img
        src="/login.png"
              ...
              <div className="pt-10">
                ...
                >
                  {!!session ? (
                    ...
                    <div className="flex items-center text-sm justify-center h-full text-center text-gray-500">
                      <span>
                        <Link href="/projects/solar-sailors-app/applications/nextjs/login" className="text-blue-500 underline">
                          Sign In
                        </Link>{" "}
                        to access projects
                      </span>
